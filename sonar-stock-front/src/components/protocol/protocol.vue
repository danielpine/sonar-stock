<template>
  <div class="protocol-main">
    ...
    <div class="content">
      <p>
        H网是一家根据相关法律注册成立的公司，该公司运营网站hht.one（以下称“本网站”或“网站”），该网站是一个专门供用户进行股票模拟盘交易和提供相关服务（以下称“该服务”或“服务”）的平台。为了本协议表述之方便，公司和该网站在本协议中合称使用“我们”或其他第一人称称呼。只要登陆该网站的自然人或其他主体均为本网站的用户，本协议表述之便利，以下使用“您”或其他第二人称。为了本协议表述之便利，我们和您在本协议中合称为“双方”，我们或您单称为“一方”。</p>


      <p>重要提示：</p>
      <p>我们在此特别提醒您：</p>
      <p> 1. 股票模拟盘本身不由任何金融机构或公司或本网站发行；</p>


      <p>2. 股票模拟盘市场是全新的、未经确认的，而且可能不会增长；</p>

      <p>3. 股票模拟盘主要由投机者大量使用，零售和商业市场使用相对较少，股票模拟盘交易存在极高风险，其全天不间断交易，没有涨跌限制，价格容易受庄家、全球政府政策的影响而大幅波动；</p>

      <p>4. 因各国法律、法规和规范性文件的制定或者修改，股票模拟盘交易随时可能被暂停或被禁止。</p>

      <p>
        股票模拟盘交易有极高风险，并不适合绝大部分人士。您了解和理解此投资有可能导致部分损失或全部损失，所以您应该以能承受的损失程度来决定投资的金额。您了解和理解股票模拟盘会产生衍生风险，所以如有任何疑问，建议先寻求理财顾问的协助。此外，除了上述提及过的风险以外，还会有未能预测的风险存在。您应慎重考虑并用清晰的判断能力去评估自己的财政状况及上述各项风险而作出任何买卖股票模拟盘的决定，并承担由此产生的全部损失，我们对此不承担任何责任。</p>

      <p>敬告您：</p>

      <p>1. 您了解本网站仅作为您获取股票模拟盘信息、寻找交易方、就股票模拟盘的交易进行协商及开展交易的场所，本网站不参与您的任何交易，故您应自行谨慎判断确定相关股票模拟盘及/或信息的真实性、合法性和有效性，并自行承担因此产生的责任与损失。</p>
      ...
      <p>1.5 只有成为本网站的会员才可使用本网站提供的股票模拟盘交易平台进行交易及享受其他本网站规定的只有会员才可获得的服务；会员外的其他您只有登陆网站、浏览网站及其他本网站规定的可获得的服务。</p>

      <p>1.6 通过注册和使用任何由本网站提供的服务和功能，您将被视为已阅读，理解并：</p>

      <p>1.6.1 接受本协议所有条款及条件的约束。</p>

      <p>1.6.2 您确认您已年满16周岁或根据不同的可适用的法律规定的具有可订立合同的法定年龄，并有充分的能力接受这些条款，并订立交易，使用本网站进行股票模拟盘交易。</p>

      <p>1.6.3 您保证交易中涉及到的属于您的股票模拟盘均为合法取得并所有。</p>
      ...
      <p>.6.7 本协议只是就您与我们之间达成的权利义务关系进行约束，而并不涉及本网站用户之间与其他网站和您之间因股票模拟盘交易而产生的法律关系及法律纠纷。</p>
      ...
      <p>您确认并承诺：您进行本网站注册并非出于违反法律法规或破坏本网站股票模拟盘交易秩序的目的。</p>
      ...
      <p>本网站只为您通过本网站进行股票模拟盘交易活动（包括但不限于股票模拟盘交易等服务）提供网络交易平台服务，本网站并不作为买家或卖家参与买卖股票模拟盘行为本身；本网站不提供任何国家法定货币充入和提取的相关服务。</p>

      <p>4.1 服务内容</p>

      <p>4.1.1 您有权在本网站浏览股票模拟盘各项产品的实时行情及交易信息、有权通过本网站提交股票模拟盘交易指令并完成股票模拟盘交易。</p>
      ...
      <p>4.2.1 您应当遵守法律法规、规章、及政策要求的规定，保证账户中所有股票模拟盘来源的合法性，不得在本网站或利用本网站服务从事非法或其他损害本网站或第三方权益的活动，如发送或接收任何违法、违规、侵犯他人权益的信息，发送或接收传销材料或存在其他危害的信息或言论，未经本网站授权使用或伪造本网站电子邮件题头信息等。</p>
      ...
      <p>4.2.4 您在本网站进行股票模拟盘交易时不得恶意干扰股票模拟盘交易的正常进行、破坏交易秩序；不得以任何技术手段或其他方式干扰本网站的正常运行或干扰其他用户对本网站服务的使用；不得以虚构事实等方式恶意诋毁本网站的商誉。</p>
      ...
      <p>5.6 本网站应当采取必要的技术手段和管理措施保障本网站的正常运行，并提供必要、可靠的交易环境和交易服务，维护股票模拟盘交易秩序。</p>

      <p> 5.7 如您连续一年未使用本网站会员账号和密码登陆本网站，则本网站有权注销您的本网站账号。账号注销后，本网站有权将相应的会员名开放给其他您注册使用。</p>

      <p>5.8 本网站通过加强技术投入、提升安全防范等措施保障您的股票模拟盘的安全，有义务在您账户出现可以预见的安全风险时提前通知您。</p>
      ...
      <p>8.3 我们对由于信息网络设备维护、信息网络连接故障、电脑、通讯或其他系统的故障、电力故障、天气原因、意外事故、罢工、劳动争议、暴乱、起义、骚乱、生产力或生产资料不足、火灾、洪水、风暴、爆炸、战争、银行或其他合作方原因、股票模拟盘市场崩溃、政府行为、 司法或行政机关的命令、其他不在我们可控范围内或我们无能力控制的行为或第三方的原因而造成的不能服务或延迟服务，以及造成的您的损失，我们不承担任何责任。</p>
      ...
      <p>8.6 我们对于您使用本网站服务不做任何明示或暗示的保证，包括但不限于本网站提供服务的适用性、没有错误或疏漏、持续性、准确性、可靠性、适用于某一特定用途。同时，我们也不对本网站提供的服务所涉及的技术及信息的有效性、准确性、正确性、可靠性、质量、稳定、完整和及时性作出任何承诺和保证。是否登陆或使用本网站提供的服务是您个人的决定且自行承担风险及可能产生的损失。我们对于股票模拟盘的市场、价值及价格等不做任何明示或暗示的保证，您理解并了解股票模拟盘市场是不稳定的，价格和价值随时会大幅波动或崩盘，交易股票模拟盘是您个人的自由选择及决定且自行承担风险及可能产生的损失。</p>
