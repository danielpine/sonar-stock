  ...
  <main class="vote-page">
    ...
    <div class="article-content d-flex justify-content-center">
      ...
      <div v-show="tab==1" class="article-body">
        ...
        <p>为了保护投资者的利益，HashToken自主股票模拟盘交易所（HHT）会对资产的合法性和真实性进行评估，只有达到投票上币要求的币种才能参与投票上币。所有上线投票的品种需要满足如下条件，包含但不限于</p>
        <p>&nbsp;</p>
        ...
        <p>&nbsp;</p>
        <p>股票模拟盘申请投票上币，请通过如下链接在线填写相关信息：</p>
        <p>
          <a href="https://goo.gl/forms/MEpM5gkQFKmElQ4x2"> https://goo.gl/forms/MEpM5gkQFKmElQ4x2</a>
        </p>
        <p>&nbsp;</p>
        <p>下线投票币种说明</p>
        <p>为保护投资者利益，HashToken自主股票模拟盘交易所（HHT）保留投票项目下线或继续支持投票项目在平台上投票的权利，项目方如果触发如下条件，我们会公告通知投票项目下线，包含但不限于：</p>
        <p>&nbsp;</p>
        <ol>
          <li>项目团队解散；</li>
          <li>项目方面临重大法律合规问题；</li>
        ...
        <p>&nbsp;</p>
        <p>HashToken自主股票模拟盘交易所（HHT）保留其他未尽事宜的处理权益。</p>
      </div>
