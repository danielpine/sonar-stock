  ...
  <div class="trading-view exchange" v-wechat-title="$t('m.navheader.trade')">
    ...
    <el-container>
      <el-main>
        ...
        >
          <grid-item
            ...
            class="dragger"
          >
            <div style="color: rgb(243, 239, 255);">K-Line</div>
          </grid-item>
          <grid-item
            :x="layout[0].x"
            :y="layout[0].y"
      ...
      <el-aside class="sonar-place-order">
        <title class="sonar-stock-grid-draggable-handle" style="margin-top: 5px;">
          <p>Place Order</p>
        </title>
        <div style="padding: 0px 10px;">
          ...
          <el-row>
            <el-button size="mini"  style="margin-top: 5px; width: 280px;" class="sonar-stock-button">
              Buy
            </el-button>
          </el-row>
        </div>
