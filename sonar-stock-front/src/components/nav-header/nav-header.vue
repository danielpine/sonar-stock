...
<!--          <span class="tab-link logo" >Sonar-stock</span>-->
          <img style="width:200px;height:33px" src="../../assets/home/logo1.png" alt="">
        </router-link>
        <router-link tag="li" to="/home">
          <span :class="activeTab === '1' ? 'tab-link active-tab' : 'tab-link'"> {{ $t('m.navheader.homeMenu') }}</span>
        </router-link>
